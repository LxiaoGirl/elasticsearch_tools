...
def parse_args():
    ...
    args_parse.add_argument('-b', '--body', default='', help='Json body E.g {"query":{"bool":{"must":[{"term":{"price":"70"}}]}}}')
    args_parse.add_argument('-s', '--size', default=100, help='Data Size E.g 2000', type=int)
    args_parse.add_argument('-f', '--skip', default=0, help='Data From E.g 4000', type=int)
    args_parse.add_argument('-l', '--limit', default=1000000, help='Data Limit E.g 4000', type=int)
